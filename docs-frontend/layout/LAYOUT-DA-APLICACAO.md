...
O shell autenticado equivale a um `ClientDashboardShell`: sidebar + topbar +
guarda de sessão em volta de toda área logada.
...
- [Next.js — Layouts and Pages](https://nextjs.org/docs/app/getting-started/layouts-and-pages) — shell composto por layout aninhado.
- [DaisyUI — Drawer](https://daisyui.com/components/drawer/) — drawer via checkbox/CSS puro (sem estado JS).
- [daisyUI — Docs](https://daisyui.com) — tokens de tema usados no shell.
