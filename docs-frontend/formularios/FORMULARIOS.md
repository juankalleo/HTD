...
O padrão de formulário usa rota própria (em vez de modal), com a cadeia
React Hook Form + Zod — ver
[`tecnologias/react-hook-form-zod.md`](/padrao-frontend/tecnologias/react-hook-form-zod)
...
inteiro do Devise, que validaria e-mail junto sem necessidade). Detalhe
completo em
[Política de senha](/padrao-frontend/seguranca/politica-de-senha).
...
o registro (`useAdminGet`, ver [`DADOS-E-API.md`](/padrao-frontend/tratamento-de-dados/dados-e-api)) e passa
...
[`DADOS-E-API.md`](/padrao-frontend/tratamento-de-dados/dados-e-api#services--só-fetch-zero-react)):
...
`useAdminCreate`/`Update`, ver [`DADOS-E-API.md`](/padrao-frontend/tratamento-de-dados/dados-e-api)) — o
...
- [React Hook Form + Zod — tecnologia do projeto](/padrao-frontend/tecnologias/react-hook-form-zod) — por que RHF + Zod na cadeia de formulário.
- [Zod — Docs](https://zod.dev) — schema nunca mais forte que o backend (parse, don't validate).
- [React Hook Form — Docs](https://react-hook-form.com) — `register`, `handleSubmit`, `setError`.
