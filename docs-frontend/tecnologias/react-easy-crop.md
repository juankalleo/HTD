...
Biblioteca headless de recorte/posicionamento de imagem — um
...
Os campos de imagem da Identidade institucional (ícone do
...
[`(../UPLOAD-DE-IMAGEM.md`](../arquivos/UPLOAD-DE-IMAGEM.md)), então o admin precisa
...
DaisyUI. Leitura de apoio:
[repositório oficial do react-easy-crop](https://github.com/ricardo-ch/react-easy-crop)
— por que um cropper puramente headless não conflita com o tema DaisyUI.
...
`shared/ui/sistema/image-cropper-modal.tsx`, dentro de um
...
O `<Cropper>` só entrega a **área** recortada (em
