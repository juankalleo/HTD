...
`echarts` é o motor de gráfico. EvilCharts, neste projeto, é a
...
O projeto precisava de gráficos sem puxar MUI X Charts e
sem criar outro design system. ECharts fica só como motor de canvas; o
acabamento visual continua controlado por Tailwind e tokens DaisyUI. Leitura
de apoio: [documentação oficial do Apache ECharts](https://echarts.apache.org/)
— por que um motor de canvas mantém o tema do projeto em vez de puxar um
design system de gráfico.
...
Wrapper de gráfico fica em `shared/ui/graficos`;
