...
usam `border-base-300` precisou mudar uma linha. Essa é a mesma técnica
usada por `--font-sans`/`--app-scale`
([`CONFIGURACAO-INSTITUCIONAL.md`](../layout/CONFIGURACAO-INSTITUCIONAL.md)) — não é
