...
resposta de admin, ver [`../ADMINISTRACAO-RBAC.md`](/padrao-frontend/seguranca/administracao-rbac)),
...
`tipo`), ver [`(../SEGURANCA-EXPORTACAO.md`](../seguranca/SEGURANCA-EXPORTACAO.md)
...
rodapé com emissor — ver [`(../ESTILOS-DE-PDF.md`](../arquivos/ESTILOS-DE-PDF.md)),
...
Excel (ver [`(../ESTILOS-DE-EXCEL.md`](../arquivos/ESTILOS-DE-EXCEL.md)).
...
- [TanStack Table — Docs](https://tanstack.com/table/latest/docs/intro) — tabela headless usada aqui (por que headless: sobre DaisyUI, sem segundo design system).
- [Apache ECharts — Docs](https://echarts.apache.org) — gráficos do relatório (wrapper `evilcharts`).
- [Puppeteer — Docs](https://pptr.dev) e [ExcelJS — GitHub](https://github.com/exceljs/exceljs) — geração de PDF/Excel no servidor.
