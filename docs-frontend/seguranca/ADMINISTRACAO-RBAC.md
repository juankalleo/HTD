...
[`DADOS-E-API.md`](/padrao-frontend/tratamento-de-dados/dados-e-api#hooks-por-feature--a-camada-de-domínio)):
...
- [OWASP — Top 10 (A01: Broken Access Control)](https://owasp.org/www-project-top-ten/) — controle de acesso é o risco nº 1; é a base do RBAC documentado aqui.
- [Role-Based Access Control: best practices (Cerbos)](https://www.cerbos.dev/blog/role-based-access-control-best-practices) — least privilege, separação de deveres e revisão periódica.
- [RBAC implementation (IBM)](https://www.ibm.com/think/topics/role-based-access-control-implementation) — modelagem de papéis a partir de funções de negócio.
