...
export function ThemeToggle() {
  ...
  function toggle() {
    ...
    try {
      window.localStorage.setItem("nexttech-theme", next);
  ...
  return (
    ...
    >
      ...
      <svg viewBox="0 0 24 24" width={24} height={24} aria-hidden="true" className="toggleIcon_ShiV darkToggleIcon_QOYG">
        <path
          fill="currentColor"
